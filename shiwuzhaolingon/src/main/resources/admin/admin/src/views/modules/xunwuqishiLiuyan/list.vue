                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/shiwuzhaolingon/upload/xunwuqishiLiuyanMuBan.xls"
                        >批量导入寻物启事留言数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('xunwuqishiLiuyan','导入导出')"
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'xunwuqishi_liuyan',//当前表表名,
                        sumColum : 'xunwuqishi_liuyan_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'xunwuqishi_liuyan_name',//分组字符串字段
                        // types : 'xunwuqishi_liuyan_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
                ...
                //         groupColumn: "xunwuqishi_liuyan_types",
                //     }
                //     this.$http({
            ...
            getDataList() {
                ...
                if (this.searchForm.zhaugntaiTypes!= '' && this.searchForm.zhaugntaiTypes!= undefined) {
