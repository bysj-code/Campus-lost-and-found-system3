        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="物品状态" prop="zhaugntaiTypes">
                        <el-select v-model="ruleForm.zhaugntaiTypes" :disabled="ro.zhaugntaiTypes" placeholder="请选择物品状态">
                            <el-option
                                v-for="(item,index) in zhaugntaiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="物品状态" prop="zhaugntaiValue">
                        <el-input v-model="ruleForm.zhaugntaiValue"
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhaugntai_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.zhaugntaiTypesOptions = data.data.list;
                    }
                });
