    ...
    export default {
        ...
        async onLoad(options) {
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`xunwuqishiLiuyan`, this.ruleForm.id);
        ...
        methods: {
			...
			if ((!this.ruleForm.xunwuqishiLiuyanText)) {
                ...
                if (this.ruleForm.id) {
                    await this.$api.update(`xunwuqishiLiuyan`, this.ruleForm);
                } else {
                    await this.$api.save(`xunwuqishiLiuyan`, this.ruleForm);
                }
