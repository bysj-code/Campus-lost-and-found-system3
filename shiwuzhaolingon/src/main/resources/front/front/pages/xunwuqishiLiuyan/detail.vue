	...
	<script>
		export default {
			...
			async onLoad(options) {
				this.xunwuqishiLiuyanId = options.id;
			},
			...
			methods: {
				...
				// 获取详情
				async init() {
					let res = await this.$api.info('xunwuqishiLiuyan', this.xunwuqishiLiuyanId);
                    this.detail = res.data
					// 主图
					this.swiperList = this.detail.xunwuqishiLiuyanPhoto ? this.detail.xunwuqishiLiuyanPhoto.split(",") : [];
				},
