        ...
        <form class="app-update-pv">
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.shiwuzhaolingUuidNumber" type="text" v-model="ruleForm.shiwuzhaolingUuidNumber" placeholder="失物编号"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                ...
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"16rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.shiwuzhaolingName" type="text" v-model="ruleForm.shiwuzhaolingName" placeholder="物品名称"></input>
            </view>
                ...
                <view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    ...
                    <picker @change="zhaugntaiTypesChange" :value="zhaugntaiTypesIndex" :range="zhaugntaiTypesOptions" range-key="indexName">
                        <view
                                :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"16rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                                class="uni-input">{{ruleForm.zhaugntaiTypes?ruleForm.zhaugntaiValue:"请选择物品状态"}}</view>
                    </picker>
                </view>
                <view
                        ...
                        class="cu-form-group" @tap="shiwuzhaolingPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                    ...
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.shiwuzhaolingPhoto" :src="baseUrl+ruleForm.shiwuzhaolingPhoto" mode="aspectFill">
                        </image>
                ...
                <input
                        :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"16rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                        v-model="ruleForm.shiwuzhaolingTime" placeholder="拾遗时间" :readonly="ro.shiwuzhaolingTime"
                        @tap="toggleTab('shiwuzhaolingTime')"></input>
            </view>
					            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                ...
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"16rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.shiwuzhaolingDizhi" type="text" v-model="ruleForm.shiwuzhaolingDizhi" placeholder="拾遗地址"></input>
            </view>
<!-- text后缀 -->
            <view
                ...
                <textarea :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"16rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx","height":"200rpx"}'
                          :disabled="ro.shiwuzhaolingContent" v-model="ruleForm.shiwuzhaolingContent" placeholder="详情"/>
            </view>
            ...
            <view class="btn">
                <button
					...
					<w-picker mode="dateTime" step="1" :current="false" :hasSecond="false" @confirm="shiwuzhaolingTimeConfirm"
                              ref="shiwuzhaolingTime" themeColor="#333333"></w-picker>
...
<script>
    ...
    export default {
		...
		/*下拉框*/
			let zhaugntaiTypesParams = {
                page: 1,
                limit: 100,
                dicCode: 'zhaugntai_types',
            }
			let zhaugntaiTypes = await this.$api.page(`dictionary`, zhaugntaiTypesParams);
			this.zhaugntaiTypesOptions = zhaugntaiTypes.data.list
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`shiwuzhaoling`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.shiwuzhaolingId){
                this.ruleForm.shiwuzhaolingId = options.shiwuzhaolingId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            async onSubmitTap() {
				if ((!this.ruleForm.shiwuzhaolingUuidNumber)) {
                    this.$utils.msg(`失物编号不能为空`);
                    return
                }
				if ((!this.ruleForm.shiwuzhaolingName)) {
                    this.$utils.msg(`物品名称不能为空`);
                    return
                }
				if ((!this.ruleForm.zhaugntaiTypes)) {
                    this.$utils.msg(`物品状态不能为空`);
                    return
                }
				if ((!this.ruleForm.shiwuzhaolingPhoto)) {
                    this.$utils.msg(`物品图片不能为空`);
                    return
                }
				if ((!this.ruleForm.shiwuzhaolingTime)) {
                    this.$utils.msg(`拾遗时间不能为空`);
                    return
                }
				if ((!this.ruleForm.shiwuzhaolingDizhi)) {
                ...
                if (this.ruleForm.id) {
                    ...
                    await this.$api.save(`shiwuzhaoling`, this.ruleForm);
                }
