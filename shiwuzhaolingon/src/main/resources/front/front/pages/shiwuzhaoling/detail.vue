		...
		<view class="container">
			...
			<view class="">
				...
				<view class="yinyuewai">
					<view class="yinyuenei">
						...
						<view class="shangpinfei">
							{{detail.shiwuzhaolingName}}<!-- <uni-icons type="scan" size="30"></uni-icons> -->
						</view>
						<view class="xiangqing">
							<view class="shangpinxiangqing">
								...
								<view class="app">
									{{detail.shiwuzhaolingUuidNumber}}
								</view>
							</view>
						</view>
						<view class="xiangqing">
				...
				<view class="yinyuewai">
					...
					margin-bottom: 25rpx;
					text-indent:24px">
							<rich-text :nodes="detail.shiwuzhaolingContent"></rich-text>
						</view>
					</view>
				</view>
				<!-- 留言 -->
...
<script>
	export default {
		...
		async onLoad(options) {
			this.shiwuzhaolingId = options.id;
		},
		...
		methods: {
			...
			// 获取详情
			async init() {
				let res = await this.$api.info('shiwuzhaoling', this.shiwuzhaolingId);
				this.detail = res.data
				this.detail.shiwuzhaolingContent = this.detail.shiwuzhaolingContent.replace("<img",
					"<img  class=\"daxiao\"").replace("src=\"upload/", "src=\"" + this.$base.url + "upload/");
				// 主图
				this.swiperList = this.detail.shiwuzhaolingPhoto ? this.detail.shiwuzhaolingPhoto.split(",") : [];
			},
